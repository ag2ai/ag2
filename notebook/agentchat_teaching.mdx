...
<div style={{ display: "inline-block", marginRight: "0px", height: "20px" }}>
  <a
    href="https://colab.research.google.com/github/ag2ai/ag2/blob/main/notebook/agentchat_teaching.mdx"
    target="_blank"
...
<div style={{ display: "inline-block", height: "20px" }}>
  <a
    href="https://github.com/ag2ai/ag2/blob/main/notebook/agentchat_teaching.mdx"
    target="_blank"
    style={{ height: "20px", display: "inline-flex", alignItems: "center" }}
  >
    <img
...
![png](agentchat_teaching_files/agentchat_teaching_9_0.png)
