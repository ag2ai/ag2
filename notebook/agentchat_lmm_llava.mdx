...
<a id="replicate"></a>
## (Option 1, preferred) Use API Calls from Replicate [Remote] We can also use
[Replicate](https://replicate.com/yorickvp/llava-13b/api) to use LLaVA directly,
which will host the model for you.
...
![png](agentchat_lmm_llava_files/agentchat_lmm_llava_17_1.png)
...
![png](agentchat_lmm_llava_files/agentchat_lmm_llava_17_3.png)
...
![png](agentchat_lmm_llava_files/agentchat_lmm_llava_17_5.png)
