...
The [`BrowserUseTool`](/docs/reference/tools/experimental/BrowserUseTool) llows agents to interact with web pages—navigating, searching, and extracting information.
...
[`Crawl4AITool`](/docs/reference/tools/experimental/Crawl4AITool) offers three integration modes:
