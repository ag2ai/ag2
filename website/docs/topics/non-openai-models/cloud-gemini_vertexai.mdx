...
<div style={{ display: "inline-block", marginRight: "0px", height: "20px" }}>
  <a
    href="https://colab.research.google.com/github/ag2ai/ag2/blob/main/website/docs/topics/non-openai-models/cloud-gemini_vertexai.ipynb"
    target="_blank"
...
<div style={{ display: "inline-block", height: "20px" }}>
  <a
    href="https://github.com/ag2ai/ag2/blob/main/website/docs/topics/non-openai-models/cloud-gemini_vertexai.ipynb"
    target="_blank"
    style={{ height: "20px", display: "inline-flex", alignItems: "center" }}
  >
    <img
...
<div>
  <img
    src="https://github.com/microsoft/autogen/blob/main/website/static/img/create_gcp_svc.png?raw=true"
    width="1000"
  />
</div>
