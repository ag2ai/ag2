...
an OpenAI-compatible API or a [custom model client](/website/blog/2024-01-26-Custom-Models)
class.
...
![Cloud or Local Proxy Servers](images/cloudlocalproxy.webp)
...
is straightforward. With [LLM Configuration](/website/docs/topics/llm_configuration) done in
...
- [Together AI example](/website/docs/topics/non-openai-models/cloud-togetherai)
- [Mistral AI example](/website/docs/topics/non-openai-models/cloud-mistralai)
- [Anthropic Claude example](/website/docs/topics/non-openai-models/cloud-anthropic)
...
- [LiteLLM with Ollama example](/website/docs/topics/non-openai-models/local-litellm-ollama)
- [LM Studio](/website/docs/topics/non-openai-models/local-lm-studio)
- [vLLM example](/website/docs/topics/non-openai-models/local-vllm)
...
the same way as using OpenAI's models, see [LLM Configuration](/website/docs/topics/llm_configuration)
for further information.

You can use [model configuration filtering](/website/docs/topics/llm_configuration#config-list-filtering)
...
blog post and [this notebook](/notebook/agentchat_custom_model/) for a guide to creating custom model client classes.
