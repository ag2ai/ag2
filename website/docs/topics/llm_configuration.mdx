...
<div class="warning">
  <Warning>
    It is important to never commit secrets into your code, therefore we read
...
<div class="tip">
  <Tip>
    By default this will create a model client which assumes an OpenAI API (or
    compatible) endpoint. To use custom model clients, see
    [here](https://github.com/microsoft/autogen/blob/main/notebook/agentchat_custom_model.ipynb).
  </Tip>
</div>
