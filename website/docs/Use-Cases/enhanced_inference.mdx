...
## Tune Inference Parameters (for openai)
...
Reset your session's usage data with `clear_usage_summary()` when needed. [View Notebook](https://github.com/ag2ai/ag2/blob/main/notebook/oai_client_cost.ipynb)
...
Moved to [here](/website/docs/topics/llm-caching).
...
We suggest that you take a look at this [notebook](/website/docs/topics/llm_configuration) for full code examples of the different methods to configure your model endpoints.
...
_Advanced use case: Check this [blogpost](/blog/2023/05/18/GPT-adaptive-humaneval) to find how to improve GPT-4's coding performance from 68% to 90% while reducing the inference cost._
