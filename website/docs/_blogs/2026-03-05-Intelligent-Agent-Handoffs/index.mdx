...
authors: [marklysze]
tags: [Handoffs, Multi-Agent, Orchestration, Group Chat]
date: 2026-03-05
...
<Note>
AG2's handoff system evolved from the earlier Swarm-based approach. The Swarm API (`initiate_swarm_chat`, `SwarmAgent`) was removed in v0.14 — its functionality is now fully provided by the Group Chat API described above. See the [release history](/docs/user-guide/release-history) for details.
</Note>
