...
![Intelligent Agent Handoffs](img/intelligent-agent-handoffs-hero.png)
...
![Handoff evaluation priority flow -- context conditions, LLM conditions, tool handoffs, and after-work fallback evaluated top to bottom](img/handoff-evaluation-priority-flow.png)
