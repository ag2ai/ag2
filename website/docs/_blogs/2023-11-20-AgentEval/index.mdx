...
* We demonstrate how `AgentEval` work using [math problems dataset](https://docs.ag2.ai/latest/docs/blog/2023/06/28/MathChat) as an example. Any feedback would be useful for future development. Please contact us on our [Discord](https://discord.gg/pAbnFJrkgZ).
...
Next, the critic is given successful and failed examples of the task execution; then, it is able to return a list of criteria (Fig. 1).
