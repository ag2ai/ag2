...
<Tabs>
  ...
  <Tab title="Conda">
    <p><a href="https://docs.conda.io/projects/conda/en/stable/user-guide/install/index.html" target="_blank" rel="noopener noreferrer">install Conda</a> if you have not already.</p>
    <p>Create and activate:</p>
      ```
