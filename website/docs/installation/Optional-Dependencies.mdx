...
```bash
pip install ag2[gemini,anthropic,mistral,together,groq,cohere]
```

<Tip>
If you have been using `autogen` or `pyautogen`, all you need to do is upgrade it using:
```bash
pip install -U autogen[gemini,anthropic,mistral,together,groq,cohere]
```
or
```bash
pip install -U pyautogen[gemini,anthropic,mistral,together,groq,cohere]
```
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/installation/Optional-Dependencies.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
