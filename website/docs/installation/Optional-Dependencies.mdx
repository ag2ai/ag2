...
Check out the [notebook](/notebook/autogen_uniformed_api_calling) and
...
See [LLM Caching](/website/docs/topics/llm-caching) for details.
...
Example notebook: [Chatting with a teachable agent](/notebook/agentchat_teachability)
...
Example notebook: [LLaVA Agent](/notebook/agentchat_lmm_llava)
...
Example notebook: [Finite State Machine graphs to set speaker transition constraints](/notebook/agentchat_groupchat_finite_state_machine)
