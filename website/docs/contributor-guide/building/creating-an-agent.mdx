...
class DiscordAgent(ConversableAgent): # Built on the ConversableAgent class
    ...
    def __init__(
        self,
        system_message: Optional[Union[str, list]] = None, # We provide the ability to override the system message
        *args,
        ...
        **kwargs: Any,
        ...
        # We set the system message to the passed in or a default value
...
Let's look at part of the [DiscordSendTool](/docs/api-reference/autogen/tools/experimental/DiscordSendTool) tool to see how a [Tool](/docs/api-reference/autogen/tools/Tool) is created (annotations added):
