...
# Denote that this requires a 3rd party package, with "crawl4ai" being the namespace
# Our AG2 'extra' is called "crawl4ai"
@require_optional_import(["crawl4ai"], "crawl4ai")
@export_module("autogen.tools.experimental") # Indicates where this appears in the API Reference documentation, autogen > tools > experimental > Crawl4AITool
