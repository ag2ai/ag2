...
<Tabs>
  ...
  1. Simply set the `OAI_CONFIG_LIST` environment variable in your terminal:
    ```bash
    ...
    ```
  2. Or you can save the `OAI_CONFIG_LIST` in a file and set the path of the file as an environment variable.
