...
=== "Using OAI_CONFIG_LIST (legacy/secondary method)"
    ...
    === "As environment variable"
        ...
        ```bash
        export OAI_CONFIG_LIST='[{"api_type": "openai", "model": "gpt-4o","api_key": "<your_api_key>","tags": ["gpt-4o", "tool", "vision"]},{"api_type": "openai", "model": "gpt-5-nano","api_key": "<your_api_key>","tags": ["gpt-5-nano", "tool", "vision"]},{"api_type": "gemini", "model": "gemini-pro","api_key": "<your_gemini_api_key>",}]'
        ```
