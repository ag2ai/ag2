...
from autogen.beta import Agent
from autogen.beta.config import AnthropicConfig
from autogen.beta.tools import TinyFishSearchToolkit
...
| Field | Description |
| :--- | :--- |
| `results` | List of successfully fetched pages with metadata, extracted `text`, links, image links, and latency |
