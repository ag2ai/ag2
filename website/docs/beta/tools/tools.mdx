...
The framework provides typed input classes for text, structured data, images, audio, video, documents, and raw binary payloads. See [Multimodal Inputs](/docs/beta/inputs/inputs) for the full reference including provider support and factory variants.
