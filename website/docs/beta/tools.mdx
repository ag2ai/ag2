...
tools = [
    WebSearchTool(web_search_version="web_search_20260209"),  # default: web_search_20250305
    WebFetchTool(web_fetch_version="web_fetch_20260209"),    # default: web_fetch_20250910
]
```
