...
* **Agent-side tool** — any participant calls a tool that closes the channel. See [Closing Channels → Agent-side tool](/docs/beta/network/termination#pattern-2--agent-side-tool).
...
See [Closing Channels](/docs/beta/network/termination) for the full picture.
