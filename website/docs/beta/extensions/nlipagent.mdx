...
[NLIP (Natural Language Interaction Protocol)](https://ecma-international.org/publications-and-standards/standards/ecma-430/){.external-link target="_blank"} is an ECMA-430 standard for interoperable agent communication over HTTP. The `autogen.beta.extensions.nlip` module lets you:
