...
!!! note
    Improtant remark: all such annotations has no effect on the tool schema for the LLM.
    It's just a technical detail for the framework to inject the dependency into the function.
