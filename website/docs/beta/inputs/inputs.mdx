...
| **Image (URL)** | Yes | Yes | Yes | Planned |
| **Image (binary)** | Yes | Yes | Yes | Planned |
| **Audio (URL)** | - | - | Yes | - |
| **Audio (binary)** | Yes | - | Yes | - |
| **Video (URL)** | - | - | Yes | - |
| **Video (binary)** | - | - | Yes | - |
| **Document (URL)** | - | Yes | Yes | Planned |
| **Document (binary)** | - | - | Yes | Planned |
| **File ID** | - | Yes | - | Planned |
...
Anthropic support for images and documents is planned. Currently only text inputs are supported.
