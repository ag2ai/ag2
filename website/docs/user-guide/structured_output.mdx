...
from autogen import Agent, ResponseSchema
...
```python linenums="1" hl_lines="3-6 8"
from autogen import Agent, response_schema
...
from autogen import response_schema
...
from autogen import Context, response_schema
...
from autogen import Agent, PromptedSchema
...
```python linenums="1" hl_lines="3"
from autogen import ResponseSchema
