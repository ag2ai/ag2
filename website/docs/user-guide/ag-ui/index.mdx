...
```python title="run_ag_ui.py" linenums="1"
...
Start from the [CopilotKit UI quickstart](./copilotkit-quickstart.mdx).

## Next steps

1. Build the AG-UI endpoint from the minimal example above.
2. Follow the [CopilotKit UI quickstart](./copilotkit-quickstart.mdx) to connect a React/Next.js client.
