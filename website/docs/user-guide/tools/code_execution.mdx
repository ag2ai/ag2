...
!!! note "`environment` is required"
    `SandboxCodeTool` has no default backend. Pass `TenkiEnvironment`, `DaytonaEnvironment`, `DockerEnvironment`, or your own `CodeEnvironment` implementation.
