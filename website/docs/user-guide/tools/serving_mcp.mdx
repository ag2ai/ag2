...
| `sse_retry_interval` | `None` | milliseconds to suggest a client waits before reconnecting a dropped SSE stream. A documented passthrough — AG2 exercises no behaviour of it |
