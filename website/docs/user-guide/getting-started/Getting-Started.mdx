...
- **New:** AG2 supports streaming agent responses, providing incremental output as generation occurs. This improves responsiveness and allows real-time feedback from agents during long or complex tasks.
...
<div class="tip">
  <Tip>
    <b>Streaming Responses:</b> When using supported LLMs and agent configurations in AG2, chat responses may appear incrementally as they are generated. This streaming provides faster feedback, especially for long outputs, allowing you to see agent results in real time where possible.
  </Tip>
</div>
