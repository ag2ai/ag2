...
[
    {
        ...
        # Optional: use image_generation, web_search, and apply_patch built-in tools
        # See https://platform.openai.com/docs/guides/images-vision?api-mode=responses
        # and apply_patch documentation
        "built_in_tools": ["image_generation", "web_search", "apply_patch"],
        # You may also use "apply_patch_async" for async file operations
    }
]
```
