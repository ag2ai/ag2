...
```bash
pip install autogen[gemini,retrievechat,lmm]
```
<Tip>
...
For guidance on using environment variables, see our [LLMs documentation](/docs/user-guide/basic-concepts/llm-configuration).
</Tip>
