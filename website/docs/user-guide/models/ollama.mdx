...
Ollama supports native tool calling (Ollama v0.3.1 library onward). If you install AG2 with `pip install autogen[ollama]` you will be able to use native tool calling.
