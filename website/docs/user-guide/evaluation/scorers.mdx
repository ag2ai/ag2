...
To locate the decisive step of multi-agent failures without an LLM judge, the [mi4afa extension](/docs/user-guide/extensions/mi4afa) reads it from an open-weight model's activations with a trained probe.
