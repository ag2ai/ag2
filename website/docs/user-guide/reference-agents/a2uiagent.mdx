...
![A2UIAgent Architecture](/docs/blog/2026-03-20-AG2-A2UI/img/a2ui-architecture.png)
...
Both transports deliver the same A2UI operations to the frontend. The A2UI Renderer — whether CopilotKit, Angular, Flutter, or plain HTML — receives the operations and renders native UI components. The renderer is transport-agnostic; it doesn't know or care whether the operations arrived via A2A or AG-UI.
