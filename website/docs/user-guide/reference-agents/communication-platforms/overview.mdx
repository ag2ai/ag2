...
```bash
pip install autogen[openai,commsagent-discord]
```
```bash
pip install autogen[openai,commsagent-slack]
```
```bash
pip install autogen[openai,commsagent-telegram]
```
...
Discord, Slack, and Telegram all have their own authentication and channel/group/bot identifiers. See this [notebook](/docs/use-cases/notebooks/notebooks/agentchat_tools_commsplatforms) for more guidance on establishing those authentication details and identifiers.
...
- [DiscordAgent](/docs/user-guide/reference-agents/communication-platforms/discordagent)
- [SlackAgent](/docs/user-guide/reference-agents/communication-platforms/slackagent)
- [TelegramAgent](/docs/user-guide/reference-agents/communication-platforms/telegramagent)

### More Code examples

See our [blog post](/docs/blog/2025-02-05-Communication-Agents/) for a demonstration of using the communication agents and this [notebook](/docs/use-cases/notebooks/notebooks/agentchat_tools_commsplatforms) for examples of using all the communication tools, and guidance on establishing the relevant authentication tokens and IDs.
