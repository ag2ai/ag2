...
```python linenums="1"
from autogen.compact import CompactTrigger
...
Both built-ins are importable from `#!python autogen.compact`.
...
from autogen.compact import TailWindowCompact
...
from autogen.compact import SummarizeCompact
...
```python linenums="1"
from autogen.events import BaseEvent, ToolCallEvent, ToolResultEvent
from autogen.knowledge import KnowledgeStore
