...
The `KnowledgeStore` protocol (importable from `#!python autogen`) defines the full API every implementation satisfies:
...
```python linenums="1"
from autogen import MemoryKnowledgeStore
...
```python linenums="1"
from autogen import SqliteKnowledgeStore
...
```python linenums="1"
from autogen import DiskKnowledgeStore
...
```python linenums="1"
from autogen import DefaultBootstrap, MemoryKnowledgeStore
...
```python linenums="1"
from autogen import Agent, EventLogWriter, MemoryKnowledgeStore, MemoryStream
...
```python linenums="1"
from autogen import LockedKnowledgeStore, SqliteKnowledgeStore
