...
2. **Workflow Design**: Design your agent workflow
    ...
    - Implement **Ending Conversations** methods to control conversation flow
...
flowchart TD
    ...
    style EndConv fill:#F0EAF7,stroke:#9C89B8,stroke-width:1.5px,color:#7B6B8D
