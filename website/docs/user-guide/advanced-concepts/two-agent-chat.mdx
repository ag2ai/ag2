...
A two-agent chat takes two inputs: a message, which can either be a string (for convenience) or a dictionary representing a message, and a context, which specifies various parameters of the chat.
