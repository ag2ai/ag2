...
!!! note "`http_client` is an `httpx2` client"
    From `openai>=3` the OpenAI SDK uses [`httpx2`](https://pypi.org/project/httpx2/), which
    ...
    [migration guide](https://github.com/openai/openai-python/blob/main/httpx2.md) calls that
