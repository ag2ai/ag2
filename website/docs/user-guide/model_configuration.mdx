...
```python linenums="1" hl_lines="6-12 17-18"
...
Structured data extraction, one of the decision shapes in [TypeSafe's docs](https://docs.typesafe.ai){.external-link target="_blank"}, is the one this provider cannot express: an object schema is rejected, since Jev answers one decision per question.
