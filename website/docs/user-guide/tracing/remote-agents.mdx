...
These are in addition to the standard agent span attributes (`gen_ai.operation.name`, `gen_ai.agent.name`, `ag2.span.type`). See the [Semantic Attributes](/docs/user-guide/tracing#semantic-attributes) section for the full list.
