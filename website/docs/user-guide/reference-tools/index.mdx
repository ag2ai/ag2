...
### Youtube Search Tool
[`YoutubeSearchTool`](/docs/api-reference/autogen/tools/experimental/YoutubeSearchTool) allows your agents to perform real-time web searches using Youtube Search, retrieving video information for better decision-making.
