...
```python linenums="1"
from autogen.events import ImageInput, AudioInput, VideoInput, DocumentInput
...
```python linenums="1"
from autogen.events import VideoInput
...
```python linenums="1"
from autogen.events import DocumentInput
...
```python linenums="1"
import anthropic
from autogen.events import ImageInput, DocumentInput
...
```python linenums="1"
from autogen.events import BinaryInput, BinaryType
...
```python linenums="1"
from autogen.events import UrlInput, BinaryType
...
from autogen.events import DocumentInput, ImageInput
