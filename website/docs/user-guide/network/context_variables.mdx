...
from autogen.network import EV_CONTEXT_SET, ChannelInject
...
```python linenums="1"
from autogen.network import ContextEquals, FromSpeaker, AgentTarget, Transition
...
```python linenums="1"
from autogen.network import ChannelStateInject
...
from autogen.network import register_condition
...
| Capability | Classic (`autogen.agentchat.group`) | AG2 workflow |
|---|---|---|
