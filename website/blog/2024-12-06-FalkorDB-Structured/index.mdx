...
For a more in-depth example, [see this notebook](/notebook/agentchat_swarm_graphrag_trip_planner/) where we create this Trip Planner workflow.
...
See the [Trip Planner](/notebook/agentchat_swarm_graphrag_trip_planner/) and [Structured Output](/notebook/agentchat_structured_outputs/) notebooks to start using Structured Outputs.
...
See the [Swarm documentation](/website/docs/topics/swarm#registering-handoffs-to-a-nested-chat) for more information.
