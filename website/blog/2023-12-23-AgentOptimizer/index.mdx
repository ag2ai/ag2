...
conversation_history is a list of dictionaries which could be got from chat_messages_for_summary in the [AgentChat](/website/docs/reference/agentchat/agentchat/) class.
