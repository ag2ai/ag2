...
- Different [conversation patterns](/website/docs/tutorial/conversation-patterns) like [sequential chats](/website/docs/tutorial/conversation-patterns#sequential-chats), [group chat](/website/docs/tutorial/conversation-patterns#group-chat), [constrained group chat](/website/docs/tutorial/conversation-patterns#constrained-speaker-selection), [customized group chat](/website/docs/topics/groupchat/customized_speaker_selection), [nested chat](/website/docs/tutorial/conversation-patterns#nested-chats) and recursive composition of them.
- Different prompting and reasoning techniques such as [reflection](/website/docs/topics/prompting-and-reasoning/reflection).
- [Tool use](/website/docs/tutorial/tool-use) and [code execution](/website/docs/tutorial/code-executors), as well as their [combination](/website/docs/topics/code-execution/user-defined-functions).
- [Planning and task decomposition](/website/docs/topics/task_decomposition).
- [Retrieve augmentation](/website/docs/topics/retrieval_augmentation).
- Integrating multiple [models](/blog/2023/11/09/EcoAssistant), [APIs](/website/docs/topics/openai-assistant/gpt_assistant_agent), [modalities](/blog/2023/11/06/LMM-Agent) and [memories](/blog/2023/10/26/TeachableAgent).
