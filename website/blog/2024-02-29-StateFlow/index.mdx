...
Transition to different states is based on specific rules. For example, at a successful "Submit" command, the model transits to the _End_ state.
...
We illustrate how to build **StateFlow** with GroupChat. Previous blog [FSM Group Chat](/website/blog/2024-02-11-FSM-GroupChat/)
...
- [StateFlow notebook](/notebook/agentchat_groupchat_stateflow)
- [GroupChat with Customized Speaker Selection notebook](/notebook/agentchat_groupchat_customized)
- [FSM Group Chat](/website/blog/2024-02-11-FSM-GroupChat/)
- [Documentation about `autogen`](/website/docs/Getting-Started)
