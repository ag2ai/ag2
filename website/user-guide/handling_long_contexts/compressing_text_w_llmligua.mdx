...
from ag2.agentchat.contrib.capabilities.text_compressors import LLMLingua
from ag2.agentchat.contrib.capabilities.transforms import TextMessageCompressor
...
import ag2
from ag2.agentchat.contrib.capabilities import transform_messages
...
researcher = ag2.ConversableAgent(
    "assistant",
