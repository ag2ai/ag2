...
from ag2.agentchat.contrib.capabilities import transforms
```
...
import ag2
from ag2.agentchat.contrib.capabilities import transform_messages, transforms
...
assistant = ag2.AssistantAgent("assistant", llm_config=llm_config)
...
def test(assistant: ag2.ConversableAgent, user_proxy: ag2.UserProxyAgent):
    for _ in range(1000):
...
assistant_with_redact = ag2.AssistantAgent(
    "assistant",
