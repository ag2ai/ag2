...
class TestPydanticAIInteroperabilityWithotContext:
    ...
    def test_with_llm(self, credentials_gpt_4o: Credentials, user_proxy: UserProxyAgent) -> None:
        ...
        user_proxy.initiate_chat(recipient=chatbot, message=[{"content": "roll a dice", "role": "user"}], max_turns=2)
...
class TestPydanticAIInteroperabilityWithContext:
    ...
    def test_with_llm(self, credentials_gpt_4o: Credentials, user_proxy: UserProxyAgent) -> None:
        ...
        user_proxy.initiate_chat(
            recipient=chatbot,
            message=[{"content": "Get player, for additional information use 'goal keeper'", "role": "user"}],
            max_turns=3,
        )
