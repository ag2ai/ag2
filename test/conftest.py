...
def credentials_gemini_realtime() -> Credentials:
    return get_credentials(
        "GEMINI_API_KEY", model="gemini-2.0-flash-exp", api_type="gemini", filter_dict={"tags": ["gemini-realtime"]}
    )
...
def credentials_gemini_flash_exp() -> Credentials:
    return get_credentials(
        "GEMINI_API_KEY", model="gemini-2.0-flash-exp", api_type="gemini", filter_dict={"tags": ["gemini-flash-exp"]}
    )
