...
from ag2.middleware.builtin.budget import (
    _SPENT_KEY,
    BudgetConfig,
    BudgetExceededError,
    BudgetMiddleware,
...
def test_budget_importable_from_builtin_init() -> None:
    ...
    import ag2.middleware.builtin as builtin_pkg
...
def test_budget_importable_from_middleware_top_level() -> None:
    ...
    # from the top-level ag2.middleware package (B-2 regression)
    import ag2.middleware as mw_pkg
