...
from autogen.a2a.executor import AgentExecutor
from autogen.a2a.extension import CONTEXT_UPDATE_METADATA_KEY
from autogen.a2a.mappers import ParsedMessage, struct_to_dict, task_state_to_status_update
from autogen.agent import Agent
from autogen.context import ConversationContext
from autogen.events import BaseEvent, ClientToolCallEvent
...
class A2UIAgentExecutor(AgentExecutor):
    ...
    Extends :class:`autogen.a2a.AgentExecutor` to:
