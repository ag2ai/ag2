...
:func:`~autogen.a2ui.incoming.iter_incoming_prompts`). So "the agent reacts
...
from autogen.tools.final import FunctionParameters
...
class A2UIAction:
    ...
    :func:`~autogen.a2ui.server_action.run_server_action`.) It is
    ...
    async def run(self, click: "A2UIIncomingAction", *, context: "ConversationContext") -> Any:
        ...
        Mirrors :meth:`~autogen.tools.final.function_tool.FunctionTool.__call__`:
