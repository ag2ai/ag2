...
class MCPServer:
    ...
    consume-side toolkit ``autogen.tools.MCPToolkit``, which connects *to*
    an MCP server.
    ...
    *not* derived from the agent's system prompt (which is internal); pass it
    ...
    pass a :class:`~autogen.mcp.sessions.SessionConfig` to tune the bound /
    ...
    async def __call__(self, scope: "Scope", receive: "Receive", send: "Send") -> None:
        ...
        :func:`autogen.mcp.security.require`), missing/invalid tokens get
