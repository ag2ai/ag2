...
class GroupChat:
    ...
    def _run_input_guardrails(
        ...
        # Run all the guardrails
        for guardrail in agent.input_guardrails:
            guardrail.enforce(context=messages)

    @staticmethod
    def _run_ouptput_guardrails(agent: "ConversableAgent", reply: str) -> None:
        ...
        for guardrail in agent.output_guardrails:
            guardrail.enforce(context=reply)
    ...
    def run_chat(
        ...
        for i in range(groupchat.max_round):
            ...
            try:
                ...
                GroupChat._run_input_guardrails(speaker, speaker._oai_messages[self])
            ...
            GroupChat._run_ouptput_guardrails(speaker, reply)
