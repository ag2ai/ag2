...
class ChromaDBQueryEngine:
    ...
    def init_db(
        ...
        **kwargs: Any,
        ...
        documents = self._load_doc(input_dir=new_doc_dir, input_docs=new_doc_paths)
    ...
    def _load_doc(  # type: ignore
        ...
        It uses LlamaIndex's SimpleDirectoryReader that supports multiple file
        [formats]((https://docs.llamaindex.ai/en/stable/module_guides/loading/simpledirectoryreader/#supported-file-types)).
