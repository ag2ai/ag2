...
class DockerEnvironment:
    """:class:`~autogen.tools.sandbox.SandboxFactory` for
    :class:`DockerSandbox`.
    ...
    All :class:`~autogen.annotations.Variable`-capable parameters
    (``image``, ``env_vars``, ``network_mode``) are resolved on
    :meth:`open` against the active
    :class:`~autogen.context.ConversationContext`. The resulting
