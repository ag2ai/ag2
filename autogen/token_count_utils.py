...
def token_left(input: Union[str, list, dict[str, Any]], model="gpt-3.5-turbo-0613") -> int:
...
def count_token(input: Union[str, list, dict[str, Any]], model: str = "gpt-3.5-turbo-0613") -> int:
...
def _num_token_from_messages(messages: Union[list, dict[str, Any]], model="gpt-3.5-turbo-0613"):
