...
The trace-based counterpart to :func:`~autogen.eval.run_agent`. Where ``run_agent``
...
come from the paired :class:`~autogen.eval.Suite` task (via
...
from autogen.stream import Stream
...
async def _grade(
    ...
    *,
    ...
    The single grading path shared by :func:`evaluate_traces` and :func:`~autogen.eval.run_agent`
