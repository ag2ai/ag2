...
"""LoopDetector — detects repetitive tool-call patterns and signals potential loops."""
...
class LoopDetector(BaseObserver):
    """Detects repetitive tool-call patterns and signals potential loops.

    Watches ToolCallEvent events and maintains a sliding window.
    Signals a WARNING when ``repeat_threshold`` consecutive identical calls
    ...
    repeat_threshold:
        Number of identical consecutive calls that trigger a signal.
    name:
