...
from autogen.exceptions import UnsupportedInputError, UnsupportedToolError
from autogen.files import FileProvider
from autogen.response import ResponseProto
from autogen.tools.builtin.code_execution import CodeExecutionToolSchema
from autogen.tools.builtin.mcp_server import MCPServerToolSchema
from autogen.tools.builtin.memory import MemoryToolSchema
from autogen.tools.builtin.shell import ShellToolSchema
from autogen.tools.builtin.skills import SkillsToolSchema
from autogen.tools.builtin.web_fetch import WebFetchToolSchema
from autogen.tools.builtin.web_search import WebSearchToolSchema
from autogen.tools.final import FunctionToolSchema
from autogen.tools.schemas import ToolSchema
...
def tool_to_api(t: ToolSchema) -> dict[str, Any]:
    if isinstance(t, FunctionToolSchema):
        ...
        # autogen does not provide a default executor for this here.
