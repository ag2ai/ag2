...
2. ``BaseObserver`` — trigger-driven monitoring primitive backed by a
   :class:`~autogen.watch.Watch`.  Subclasses implement ``process`` and
   optionally return an :class:`~autogen.events.ObserverAlert`
...
from autogen.events import BaseEvent, ObserverAlert
from autogen.events.conditions import Condition, TypeCondition
from autogen.types import ClassInfo
from autogen.watch import Watch
