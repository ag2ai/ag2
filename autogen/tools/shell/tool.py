...
from autogen.tools.sandbox import LocalEnvironment, SandboxFactory
...
class SandboxShellTool(Tool):
    ...
    **tool** decides the agent-facing policy (``allowed`` / ``blocked`` /
    ...
    :class:`~autogen.tools.SandboxCodeTool`.

    Not to be confused with :class:`~autogen.tools.ShellTool`, which is
    ...
    Examples::
        ...
        from autogen.tools import SandboxShellTool, LocalEnvironment
