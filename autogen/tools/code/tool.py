...
from autogen.annotations import Context
from autogen.middleware import BaseMiddleware, ToolMiddleware
from autogen.tools.final import tool
from autogen.tools.final.function_tool import FunctionTool
from autogen.tools.sandbox import CodeAdapter, SandboxFactory
from autogen.tools.tool import Tool

from .environment import CodeEnvironment, CodeLanguage

if TYPE_CHECKING:
    from autogen.tools.sandbox import LanguageRunner
...
class SandboxCodeTool(Tool):
    ...
    :class:`~autogen.tools.SandboxShellTool`.

    Unlike :class:`~autogen.tools.CodeExecutionTool` (which delegates
    ...
    :class:`~autogen.tools.LocalEnvironment` is accepted but only when
    ...
    Examples::
        ...
        from autogen.tools.sandbox import CodeAdapter, LocalEnvironment, LanguageRunner
