...
from autogen.tools.sandbox.base import ExecResult, Sandbox
from autogen.tools.sandbox.factory import SandboxFactory, SingletonFactory
from autogen.tools.sandbox.filter import READONLY_COMMANDS, check_ignore, contains_shell_operator, matches
...
class ShellAdapter:
    ...
    Args:
        sandbox: Either a long-lived :class:`Sandbox` (used as-is) or a
                 ...
                 :class:`~autogen.annotations.Variable` parameters
    ...
    def workdir(self) -> "Path | PurePosixPath":
        ...
        :class:`~autogen.tools.sandbox.LocalEnvironment` /
