...
from autogen.tools.code.environment.base import CodeLanguage, CodeRunResult
from autogen.tools.sandbox.base import Sandbox
...
class CodeAdapter:
    """One :class:`~autogen.tools.code.CodeEnvironment` implementation
