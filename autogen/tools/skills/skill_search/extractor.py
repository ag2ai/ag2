...
from autogen.exceptions import SkillInstallError
from autogen.tools.skills.runtime.local.loader import SkillLoader, parse_frontmatter
...
def extract_skill(tar_path: Path, skill_id: str, dest: Path) -> SkillMetadata:
    ...
    Returns validated :class:`~autogen.tools.skills.skill_types.SkillMetadata`
