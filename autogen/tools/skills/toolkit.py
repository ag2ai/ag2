...
from autogen.exceptions import SkillNotFoundError
from autogen.middleware import ToolMiddleware
from autogen.tools.final import Toolkit, tool
from autogen.tools.final.function_tool import FunctionTool
from autogen.tools.skills.runtime import LocalRuntime, MemoryRuntime, MemorySkill, SkillRuntime
from autogen.tools.skills.skill_types import Skill
...
class SkillsToolkit(Toolkit):
    ...
    the next only on :class:`~autogen.exceptions.SkillNotFoundError`, so the
